...
from config.postgres.model_base import t_connect_authors, t_connect_keys, t_connect_words
from config.postgres.models import Word, Key, Event, Author, Type, Definition
